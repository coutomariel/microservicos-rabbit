package br.com.coutomariel.orders.processor.config
...
class RabbitmqConfig {
    ...
    @Bean
    fun processorsQueue() = Queue(queueName)

    @Bean
    fun binding() = BindingBuilder.bind(processorsQueue()).to(ordersExchange())
